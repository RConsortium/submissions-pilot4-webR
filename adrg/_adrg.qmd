...
Enter the following commands in the R console to extract the Shiny application files and environment lockfile to the appropriate destination directory:
...
source("C:/pilot4webR/m5/datasets/rconsortiumpilot4webR/analysis/adam/programs/utils.R")
